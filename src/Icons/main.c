...
int main(void) {
	...
	rhombus(256, 256, 0.01, 0.5, 0.99, 0.8, 60.0, 197.0, 193.0, 197.0, 193.0, 226.0, 60.0, 226.0, "box2.png");
	rhombus(256, 256, 0, 0, 0.9, 0.8, 23.0, 22.0, 229.0, 22.0, 229.0, 178.0, 22.0, 179.0, "box3.png");
	rhombus(256, 256, 0, 0, 0.9, 0.8, 64.0, 228.0, 195.0, 228.0, 216.0, 255.0, 38.0, 255.0, "box4.png");
